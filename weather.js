...
const ip = navigator.geolocation.getCurrentPosition(test_func, console.log);

function test_func(position){
    console.log(position)
    let latitude = position.coords.latitude;
    let longitude = position.coords.longitude;

    let weather_api = 'e30ebb7aab8826818fbbe25e3c4f7e69';
    const weather = fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${latitude}&lon=${longitude}&exclude=minutely,hourly&units=metric&appid=${weather_api}`)
